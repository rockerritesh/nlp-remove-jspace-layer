...
![Architecture: removing a meaning-forming layer from Llama-3.1-8B](figures/architecture.png)

*(Figure generated by [`figures/make_figure.py`](figures/make_figure.py) — also available as [PDF](figures/architecture.pdf).)*
